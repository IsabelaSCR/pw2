...
<head>
				<meta charset="utf-8">
				<title>Exercício 02 - Resultado</title>
...
<br>
        ...
        $totalPresunto = $lanches*$presunto;
        $totalQueijo = $lanches*$queijo;
        $totalCarne = $lanches*$carne;


        echo "<br>➝ Presunto - Peso Total: <b>$totalPresunto g</b><br>";
        echo "<br>➝ Queijo - Peso Total: <b>$totalQueijo g</b><br>";
        echo "<br>➝ Carne - Peso Total: <b>$totalCarne g</b>";
